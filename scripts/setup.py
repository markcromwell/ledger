'''
setup.py — Install Decision Ledger on a new machine.
...
def run_install(args):
    ...
    if wait_healthy(health_url):
        print(_GREEN("\nDecision Ledger is up and healthy."))
        print(f"\nNext steps:")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Decision Ledger installer")
